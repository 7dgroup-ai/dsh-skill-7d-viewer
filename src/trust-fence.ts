/**
 * Browser-trust fence for the viewer routes, behaviorally identical to the
 * /api gateway's fence in @deepseek-ai/dsh-client-connection. Host-header
 * loopback or a configured trusted authority passes; cross-site browser
 * markers refuse. This is a DNS-rebinding / cross-site defense, not auth.
 * @module dsh-skill-7d-viewer/trust-fence
 */
...
/**
 * Decide whether one viewer request may reach the plugin routes.
